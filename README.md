...
[![build-ublue](https://github.com/bpbeatty/workstation/actions/workflows/build.yml/badge.svg)](https://github.com/bpbeatty/workstation/actions/workflows/build.yml)
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/bpbeatty/base
